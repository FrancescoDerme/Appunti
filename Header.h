#pragma once
 #include <string> #include <vector> #include <math.h> #include <fstream> #include <stdio.h> #include <iostream> #include <stdlib.h> #include <sys/stat.h>
//Toolbox.
...
void Abbreviator(std::vector<std::string>& Text, int language, int *corrections); void BuildDictionary(std::vector<std::vector<std::string>>& Dictionary, int language);
//Separator.
...
//Corrector.
void Corrector(std::vector<std::string>& Text, std::vector<std::vector<std::string>>& Dictionary, int language, int *corrections); //Evaluator.
